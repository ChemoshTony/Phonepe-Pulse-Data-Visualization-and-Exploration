...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Chemosh",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Chemosh*!
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("E:\\GUVI_Files\\Project_02\\Data\\Statenames.csv")
            df1.State = df2
